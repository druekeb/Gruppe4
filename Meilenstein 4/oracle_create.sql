...
(
  ...
  CONSTRAINT MARKUPS_ARTIKEL_ID_FK FOREIGN KEY (ARTIKEL_ID)
...
(
  ...
  CONSTRAINT RAEUME_GEBAUEDE_FK FOREIGN KEY (GEBAEUDE_ID)
...
(
  ...
  CONSTRAINT MITARBEITER_RAUM_FK FOREIGN KEY(RAUM_ID)
  REFERENCES RAEUME(RAUM_ID),
  CONSTRAINT MITARBEITER_LEHRGEBIET_FK FOREIGN KEY(LEHRGEBIET_ID)
...
(
  ...
  KURSLEITER_ID NUMBER NOT NULL,
  CONSTRAINT KURS_PK PRIMARY KEY (KURS_NR, SEMESTER),
  CONSTRAINT KURS_LEITER_FK FOREIGN KEY(KURSLEITER_ID)
...
ALTER TABLE TABLE_COLUMNS 
  ADD CONSTRAINT Table_columns_pk PRIMARY KEY (table_name, column_name)
/
ALTER TABLE MARKUPS 
  ADD CONSTRAINT TABLE_CLOUMN_FK FOREIGN KEY(TABLE_NAME, COLUMN_NAME) 
