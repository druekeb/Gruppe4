...
CREATE UNIQUE INDEX  "ARTIKELVERSION_PK" ON  "ARTIKELVERSION" ("ARTIKELVERSION_ID")
/
CREATE UNIQUE INDEX  "ARTIKEL_PK" ON  "ARTIKEL" ("ARTIKEL_ID")
/
CREATE UNIQUE INDEX  "BENUTZER_PK" ON  "BENUTZER" ("BENUTZER_ID")
/
CREATE UNIQUE INDEX  "MEDIEN_PK" ON  "MEDIEN" ("MEDIEN_ID")
/
CREATE UNIQUE INDEX  "MENUBAUM_PK" ON  "MENUBAUM" ("MENUBAUM_ID")
/
CREATE UNIQUE INDEX  "ROLLE_PK" ON  "ROLLE" ("ROLLE_ID")
/
CREATE UNIQUE INDEX  "SCHLAGWORT_PK" ON  "SCHLAGWORT" ("SCHLAGWORT_ID")
/
CREATE UNIQUE INDEX  "SPERRE_PK" ON  "SPERRE" ("ARTIKELVERSION_ID")
/
CREATE UNIQUE INDEX  "SYS_IL0000013659C00008$$" ON  "ARTIKELVERSION" (
/
CREATE UNIQUE INDEX  "SYS_IL0000013659C00009$$" ON  "ARTIKELVERSION" (
/
